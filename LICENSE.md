...
No warranties are given. You may not apply legal terms or technological measures that legally restrict others from doing anything the license permits.
...
This mod is distributed **free of charge** on [CurseForge](https://www.curseforge.com/minecraft/mc-mods/consolefilternext) and [Modrinth](https://modrinth.com/mod/consolefilternext).  
Platform availability does not change the license terms above.

---

## Third-party components

- **Minecraft** and **Forge** are property of their respective owners and are not covered by this license.  
- **Gradle Wrapper** is licensed under the Apache License 2.0.
