...
public class ConsoleFilterConfigScreen extends Screen {
	...
	protected void init() {
		...
		for (String listKey : ConfigEditorModel.FILTER_LIST_KEYS) {
			...
			addRenderableWidget(Button.builder(
				...
				button -> minecraft.gui.setScreen(new FilterListEditScreen(this, model, listKey))
		...
		addRenderableWidget(Button.builder(Component.literal("Import..."), button -> minecraft.gui.setScreen(new ConfigPathScreen(this, model, configPath, true)))
			.bounds(left + 252, height - 76, 70, 20).build());
		addRenderableWidget(Button.builder(Component.literal("Export..."), button -> minecraft.gui.setScreen(new ConfigPathScreen(this, model, configPath, false)))
	...
	private void reloadFromDisk() {
		...
		minecraft.gui.setScreen(new ConsoleFilterConfigScreen(parent, host, fallbackConfigPath));
	}
	...
	public void extractRenderState(GuiGraphicsExtractor graphics, int mouseX, int mouseY, float partialTick) {
		...
		graphics.text(font, "File: " + configPath.getFileName(), 20, height - 44, 0x888888);
