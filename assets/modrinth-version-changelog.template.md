<!--
  Plantilla del changelog de versión para Modrinth (campo changelog al publicar).
  Copiar a modrinth-version-changelog.md y actualizar antes de cada release.
  ...
  - Referenciado desde assets/modrinth.json → version_changelog_file
-->
